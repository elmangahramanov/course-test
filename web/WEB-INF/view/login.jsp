	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form class="login100-form validate-form" action="${pageContext.request.contextPath}/ns?action=login">
					...
					<div class="text-center w-full p-t-115">
						...
						<a class="txt1 bo1 hov1" href="${pageContext.request.contextPath}/ns?action=register">
							Sign up now							
						</a>
					</div>
				</form>
